    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img class="img02" alt="" src="../assets/images/iconlogo.png">
                <span class="username">Syahrul Romadoni</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <?php /*<li><a href="media.php?page=edit_guru&id=<?php echo $_SESSION['iduser'] ?>"><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> Profile</a></li>*/ ?>
