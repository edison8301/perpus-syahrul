                ...
                <?php
                  ...
                  if (isset($_GET['id'])) {
                    ...
                    header("location:../media.php?page=edit_profile");
                  }
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form method="POST" action="halaman/aksi_edit_profile.php" class="cmxform form-horizontal" id="commentForm" novalidate="novalidate">
