	...
	<div class="w3layouts-main">
		...
		<h2>Register</h2>
			<form action="aksi_register.php" method="POST" enctype="multipart/form-data">
				...
				<input type="text" class="ggg" name="username" required="" maxlength="35" minlength="2">

				<p style="float: left;">Nama :</p>
				<input type="text" class="ggg" name="nama" required="" maxlength="35" minlength="2">

				<p style="float: left;">Password :</p>
				<input type="password" class="ggg" name="password" required="" maxlength="35" minlength="8">

                <p style="float: left;">Alamat :</p>
                <textarea style="width: 407px" class="ggg" id="ccomment"  name="alamat" required="" maxlength="150"></textarea><br><br>

				<p style="float: left;">Telepon :</p>
				<input type="text" class="ggg" name="telepon" required="" maxlength="16" minlength="13" onkeypress="return angka(event)">

				<p style="float: left;">Email :</p>
				<input type="email" class="ggg" name="email" required="" maxlength="35" minlength="8">

				<!-- <p style="float: left;">Foto :</p>
