<head>
	<title><?php echo $_SESSION['username']; ?> - PENULIS</title>
</head>
<!-- |==========================================================| -->
<!-- |====================| navigasi start |====================| -->
<!-- |==========================================================| -->
					      ...
					      <table id="data" class="table table-striped b-t b-light">
					        ...
					        <tbody>
					          ...
					          <tr>
					            ...
					            <td>
					            	<a href="media.php?page=detail_penulis&id=<?php echo $data['id']?>"><button class="btn btn-success" type="submit"><i class="fa fa-eye"></i></button></a>
                                    <a href="media.php?page=edit_penulis&id=<?php echo $data['id'] ?>"><button class="btn btn-success" type="submit"><i class="fa fa-pencil"></i></button></a>
