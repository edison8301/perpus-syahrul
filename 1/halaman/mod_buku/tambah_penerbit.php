                ...
                <head>
                    <title><?php echo $_SESSION['username']; ?> - TAMBAH PENERBIT</title>
                </head>
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form method="POST" action="halaman/mod_buku/aksi_tambah_penerbit.php" class="cmxform form-horizontal" id="commentForm" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="cname" name="telepon" minlength="2" maxlength="45" type="text" required="" onkeypress="return angka(event)">
                                        </div>
                                    </div>
                                    <div class="form-group">
