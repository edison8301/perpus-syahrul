                ...
                ?>
                <head>
                    <title><?php echo $_SESSION['username']; ?> - TAMBAH ANGGOTA</title>
                </head>
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form method="POST" action="halaman/mod_anggota/aksi_tambah_anggota.php" class="cmxform form-horizontal" id="commentForm" novalidate="novalidate">
